...
var langTexts = {
	ko: {
		...
		about_ceo_para1:
			'이중희 박사는 사이버보안 및 블록체인 기술 분야의 세계적으로 저명한 학자이자 산업 리더입니다. 미국 조지아 공과대학교(Georgia Tech)에서 공학 박사 학위를 취득했으며, 현재 "한국의 아이비리그"로 불리는 고려대학교에서 사이버보안 정교수로 재직하고 있습니다.',
		about_ceo_para2:
		...
		footer_address: "주소",
		footer_address_detail: "부산광역시 동구 중앙대로 365, 7층(수정동)",
	...
	en: {
		...
		slider_android_download: "Google Play Download",
		header_coming_soon: "Coming Soon",
		...
		about_people_title: "Professor Junghee Lee, Ph.D.(CEO)",
		about_ceo_para1:
		...
		footer_address_detail:
			"7F, 365, Jungang-daero, Dong-gu, Busan, Republic of Korea",
