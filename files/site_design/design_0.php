...
$designInfo->module->{'board'}->{'skin'} = 'bh';
...
$designInfo->module->{'extravar'} = new stdClass;
$designInfo->module->{'extravar'}->{'skin'} = 'default';
...
$designInfo->module->{'popup'} = new stdClass;
$designInfo->module->{'popup'}->{'skin'} = 'default';